...
export default function AgendamentoBalanceamento ({navigation}) {
  ...
  const agendar = ()=> {
      dados = {tipoDeServico:"Balanceamento", tipoDeVeiculo, dataDoAgendamento, horario};
  ...
  return(
      <View>
        <div>
        <Card >
          <Card.Title>Serviço<br/> Balancemanto</Card.Title>    
        </Card>
          <Card >
